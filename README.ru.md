...
![Сессия переезжает с одной машины на другую](docs/demo.gif)

<sub>Записано на одном хосте с двумя изолированными `$HOME` — поэтому у обеих
машин один и тот же дистрибутив. Всё, что в кадре, — настоящий вывод движка;
сценарий лежит в `demo/`.</sub>
